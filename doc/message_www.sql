...
-- ----------------------------
-- Table structure for yii2_account
-- ----------------------------
DROP TABLE IF EXISTS `yii2_account`;
CREATE TABLE `yii2_account` (
  `account_id` int(8) NOT NULL AUTO_INCREMENT,
  `c_date` varchar(20) NOT NULL COMMENT '时间',
  `recharge_count` int(8) DEFAULT '0' COMMENT '充值数量',
  `consume_count` int(8) DEFAULT '0' COMMENT '消耗数量',
  `fail_count` int(8) DEFAULT '0' COMMENT '失败返还数量',
  `create_time` int(10) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`account_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of yii2_account
-- ----------------------------
...
INSERT INTO `yii2_admin` VALUES ('8', 'test', '$2y$13$A94adm0j9A.74StXOCwh3uswtkEUj6U1KImZWRagCOv89RGohmITW', 'eiUh5Y4xi6udtXKXIMDAchC156MzlGxy', 'test@qq.com', '13012345678', '1517365306', '2130706433', '0', '2130706433', '0', '1');
...
INSERT INTO `yii2_article` VALUES ('7', '1', 'hezuo', '合作伙伴', '0', '合作伙伴', '<p>合作伙伴合作伙伴合作伙伴合作伙伴合作伙伴合作伙伴合作伙伴合作伙伴合作伙伴合作伙伴合作伙伴合作伙伴合作伙伴合作伙伴</p>', '', '', '0', '0', '0', '0', '1473606940', '0', '1');
...
INSERT INTO `yii2_article` VALUES ('11', '1', 'testabout', '测试关于我们', '13', '文章描述', '<p>文章内容<img src=\"/storage/image/201612/editor1481280050913260.png\" title=\"editor1481280050913260.png\" alt=\"ad.png\"/></p>', '', '', '0', '0', '0', '0', '1480907480', '1481280055', '1');
...
-- ----------------------------
INSERT INTO `yii2_article_cat` VALUES ('1', '0', 'about', '关于我们', '', '', '', '', '', '1379474947', '1479373724', '10', '1');
INSERT INTO `yii2_article_cat` VALUES ('3', '0', 'event', '活动', '', 'a:2:{s:2:\"sd\";s:2:\"11\";s:4:\"sdfs\";s:3:\"222\";}', '测试标题', '测试seo关键词', '测试描述', '1471947194', '1473604631', '1', '1');
INSERT INTO `yii2_article_cat` VALUES ('4', '1', 'lianxi', '联系我们', '', '', '', '', '', '1479368832', '0', '0', '1');
INSERT INTO `yii2_article_cat` VALUES ('5', '3', 'xin', '最新活动', '', '', '', '', '', '1479368867', '1479373985', '10', '1');
INSERT INTO `yii2_article_cat` VALUES ('6', '3', 'hot', '热门活动', '', '', '', '', '', '1479373707', '1481280086', '9', '1');
INSERT INTO `yii2_article_cat` VALUES ('7', '4', 'lianxi3', '联系我们3', '', '', '', '', '', '1479374778', '0', '0', '1');
...
-- ----------------------------
INSERT INTO `yii2_auth_assignment` VALUES ('administrator', '1', '1476437918');
...
INSERT INTO `yii2_auth_assignment` VALUES ('Test', '8', '1517365319');
...
INSERT INTO `yii2_auth_item` VALUES ('Test', '1', '短信商户测试', null, null, '1517206384', '1517283560');
...
-- ----------------------------
INSERT INTO `yii2_auth_item_child` VALUES ('Test', 'account/index');
...
INSERT INTO `yii2_auth_item_child` VALUES ('editor', 'goods/index');
...
INSERT INTO `yii2_auth_item_child` VALUES ('administrator', 'message/add');
INSERT INTO `yii2_auth_item_child` VALUES ('Test', 'message/add');
INSERT INTO `yii2_auth_item_child` VALUES ('administrator', 'message/index');
INSERT INTO `yii2_auth_item_child` VALUES ('Test', 'message/index');
...
INSERT INTO `yii2_auth_item_child` VALUES ('Test', 'report/index');
...
INSERT INTO `yii2_menu` VALUES ('43', '订单', '0', '3', 'order/index', '1', '', '1');
...
-- ----------------------------
-- Table structure for yii2_message_list
-- ----------------------------
DROP TABLE IF EXISTS `yii2_message_list`;
CREATE TABLE `yii2_message_list` (
  `message_id` int(8) NOT NULL AUTO_INCREMENT,
  `phonenumbers` text NOT NULL COMMENT '手机号码',
  `content` varchar(200) NOT NULL COMMENT '短信内容',
  `send_time` int(10) NOT NULL COMMENT '发送时间',
  `create_time` int(10) NOT NULL COMMENT '创建时间',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '状态',
  PRIMARY KEY (`message_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='短信列表';

-- ----------------------------
-- Records of yii2_message_list
-- ----------------------------
...
INSERT INTO `yii2_picture` VALUES ('14', '201801/1517209469968.png', 'a125213567605ad59713af85af37ff14', '1517209469', '1');
...
-- ----------------------------
-- Table structure for yii2_report
-- ----------------------------
DROP TABLE IF EXISTS `yii2_report`;
CREATE TABLE `yii2_report` (
  `report_id` int(8) NOT NULL AUTO_INCREMENT,
  `c_date` varchar(20) NOT NULL COMMENT '时间',
  `send_count` int(8) DEFAULT '0' COMMENT '发送数量',
  `success_count` int(8) DEFAULT '0' COMMENT '发送成功数量',
  `create_time` int(10) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`report_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of yii2_report
-- ----------------------------
...
INSERT INTO `yii2_user` VALUES ('19', 'feifeifei', '$2y$13$MRvZElUImZ.8gMsNV5ZEKuIkdkEamyc1tw/FHoPgQdp5x.WIPOroi', 'KWzNd8A57uVSMeLpDUB_ol1egfLPJ58C', null, '13631539420', '1474444147', '3070991720', '0', '3070991720', '0', '0', '', '0', '0', '0', '0', '1');
